...
days:
    ...
    stops:
      ...
      - type: spot
        ...
        chips:
          ...
          - { type: info, text: 1 間客房 × 4 晚 }
        links:
          - { type: map, url: "https://www.google.com/maps/search/?api=1&query=Monba+Apartment+Hotel+Mihama+8-12+Chatan+Okinawa", text: 飯店位置 }
        tips:
          - 公寓式酒店有廚房,方便熱奶與副食品
          - 附近超市可補尿布、奶粉
      - type: spot
    ...
    stops:
      ...
      - type: spot
        ...
        links:
          ...
          - { type: web, url: "https://www.gyokusendo.co.jp/okinawaworld/", text: 官方網站 }
        tips:
          - 玉泉洞內有階梯,不適合推車 — 輪流抱小孩或讓長輩慢慢走
          - 王國村平地多,推車較友善
          - 園區可免費借輪椅,部分無障礙設施
          - 建議穿舒適鞋、帶薄外套(洞內涼)
  ...
  - num: 4
    date: "5/2 (六)"
    dateFull: 2026 年 5 月 2 日 · 星期六
    theme: 兒童王國 Kodomonokuni
    sub: 動物 + 遊樂設施 + 科學體驗
    stops:
      - type: move
        time: "09:00"
  ...
  - num: 5
    date: "5/3 (日)"
    dateFull: 2026 年 5 月 3 日 · 星期日
    theme: 返程日
    sub: Departure · 最後的美國村時光
    stops:
      - type: spot
        time: 10:00 前
        badge: 退房
